...
public class CollisionSenses : CoreComponent
{
    ...
    {
        get => Physics2D.Raycast(wallCheck.position, Vector2.right * core.movement.faceingDirection, wallCheckDistance, whatIsGround);
    }

    public bool Ledge
    {
        get => Physics2D.Raycast(ledgeCheck.position, Vector2.right * core.movement.faceingDirection, wallCheckDistance, whatIsGround);
    }
